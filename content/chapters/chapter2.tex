...
\subsection{An\'alisis orientado a la detecci\'on de anomal\'ias}
    ...
    \begin{description}
        ...
        Las Tablas~\ref{tab:estadisticos} y~\ref{tab:medias_clase} permiten
        ...
        clase predicha ser\'a marcada como potencialmente an\'omala.

        \item[Outliers detectados en el modelo PCA.]
        Las observaciones identificadas en las Tablas~\ref{tab:hotelling}
        y~\ref{tab:qresiduals} mediante $T^2$ de Hotelling y Q-residuals
        ...
        en el espacio PCA sea flaggeada autom\'aticamente para revisi\'on por el
        en\'ologo.

        \item[Variables m\'as sensibles a la detecci\'on de anomal\'ias.]
        Del an\'alisis de loadings PCA (Tabla~\ref{tab:loadings}) se desprende
