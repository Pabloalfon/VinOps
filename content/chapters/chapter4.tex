...
Figuras~\ref{fig:mlflow-experiments}, \ref{fig:wine_random_forest_experiment_Run} y \ref{fig:wine_random_forest_mlmodel}.

\section{Evidencias del bonus MLflow}

Las Figuras~\ref{fig:mlflow-experiments}, \ref{fig:wine_random_forest_experiment_Run} y \ref{fig:wine_random_forest_mlmodel} muestran, respectivamente,
...
En la Figura~\ref{fig:mlflow-experiments} puede observarse el experimento \texttt{DISIA Bonus MLflow} con la ejecuci\'on
\texttt{wine\allowbreak\_random\allowbreak\_forest\allowbreak\_bonus} registrada correctamente. Esta vista resulta \'util para mostrar de forma global la relaci\'on
entre experimento, ejecuci\'on y modelo asociado.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{Pictures/mlflow_experiments.png}
    \caption{Vista general del experimento registrado en MLflow.}
    \label{fig:mlflow-experiments}
\end{figure}

La Figura~\ref{fig:wine_random_forest_experiment_Run} presenta el detalle de la ejecuci\'on, incluyendo m\'etricas, par\'ametros y metadatos
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{Pictures/wine_random_forest_experiment_Run.png}
    \caption{Detalle de la ejecuci\'on registrada, incluyendo m\'etricas y par\'ametros.}
    \label{fig:wine_random_forest_experiment_Run}
\end{figure}

Finalmente, la Figura~\ref{fig:wine_random_forest_mlmodel} muestra el modelo almacenado en MLflow y vinculado a la ejecuci\'on de origen.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{Pictures/wine_random_forest_mlmodel.png}
    \caption{Modelo almacenado en MLflow y vinculado a la ejecuci\'on de origen.}
    \label{fig:wine_random_forest_mlmodel}
\end{figure}
